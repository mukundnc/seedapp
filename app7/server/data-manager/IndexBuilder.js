...
IndexBuilder.prototype.getProductsByBrandName = function(brand, count){
	if(count === 0) return [];
...
IndexBuilder.prototype.getDateInstances = function(year, q, count){
	var months = [];
...
IndexBuilder.prototype.shuffleArray = function(o){
